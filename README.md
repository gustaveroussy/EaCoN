...
- Full workflow analysis, from the raw data to an annotated HTML report :
  - L2R and BAF normalization from raw data using
    - **Affymetrix Power Tools** (binaries, embedded) for Affymetrix arrays and the **rawcopy** BAF normalization methods
...
```R
ASCN.ff(RDS.file = "/home/me/my_project/EaCoN_results/SAMPLE1/ASCAT/L2R/SAMPLE1.EaCoN.ASPCF.RDS")
```
